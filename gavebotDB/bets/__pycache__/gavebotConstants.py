...
sql_GET_UPCOMING_EVENTS_BY_LEAGUE = "SELECT * FROM events WHERE leagueid IN ( SELECT leagueid FROM league WHERE league = 'MLB' ) AND completed = 'N' AND started = 'N' ORDER BY eventtime ASC;"
...
sql_GET_CONTESTIDS = "SELECT contestid FROM contest"
